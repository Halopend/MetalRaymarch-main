...
enum FunctionConstantIndex: Int {
    ...
    case hasHandField = 17   // Compiles out the hand-field DE-tail (hand balls + forearm carves); macOS has no hand tracking and always bakes it off (FC_HAS_HANDFIELD)
}
