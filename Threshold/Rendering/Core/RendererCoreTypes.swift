...
// FunctionConstantIndex lives in FunctionConstants.swift — this file imports
// CompositorServices and is excluded from the Mac/iOS targets, which also set
// function constants (TECH_DEBT #21).
